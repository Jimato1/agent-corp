// CMDB design system — public barrel.
...
//
// CMDB deltas vs the chat port: TierBadge IS included (provenance of Wazuh facts),
// FenceState is NOT (CMDB holds no lease/mutex/approval — that absence is a
// PrintedAbsence printed fact, never a greyed control).
...
export type { TierBadgeProps, TrustTier } from './TierBadge';
